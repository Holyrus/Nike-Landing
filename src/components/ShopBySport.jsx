  ...
  return (
    <section className="flex flex-col mt-[20px]">
        ...
        <div 
            ...
            className="pb-[30px] px-[24px] lg:px-[48px] w-full flex flex-row flex-nowrap gap-3 h-[347px] md:h-[512px] lg:h-[347px] xl:h-[437px] overflow-x-scroll scrollbar-none hover:scrollbar scrollbar-track-transparent scrollbar-thumb-[#8c8c8cff]">
