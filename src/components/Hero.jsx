...
const Hero = () => {
  ...
  return (
    <section className="w-full relative bg-white overflow-hidden h-[82vh] sm:h-[65vh] md:h-[32vh] lg:h-[45vh] xl:h-[57vh]">
        ...
        <video
          ...
          muted
          loop
          className='w-full object-cover h-[82vh] sm:h-[65vh] md:h-[32vh] lg:h-[45vh] xl:h-[57vh]'
          controls={false}>
          Video is not supported
        </video>

        <div className="absolute w-full pl-[1.5rem] lg:pl-[3rem] lg:pb-[50px] pb-[25px] sm:pt-[60px] h-[82vh] sm:h-[65vh] md:h-[32vh] lg:h-[45vh] xl:h-[57vh] lg:pt-[120px] gap-2 sm:gap-2 lg:gap-3 top-0 right-0 bg-transparent flex text-white flex-col items-start justify-end">
