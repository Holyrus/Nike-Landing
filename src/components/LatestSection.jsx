    ...
    <section className="flex flex-col mt-[48px]">
        ...
        <div 
            ...
            {LATEST.map((item, index) => (
                <a href={item.href} key={index} className="w-[300px] h-[423px] md:w-[680px] md:h-[900px] lg:w-[380px] lg:h-[530px] object-cover flex-shrink-0">
                    <img src={item.image} alt={item.title} className={`w-[300px] h-[375px] md:w-[680px] md:h-[850px] lg:w-[400px] lg:h-[480px]`}/>
