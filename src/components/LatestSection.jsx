  ...
  return (
    <section className="flex flex-col mt-[48px]">
        ...
        <div 
            ...
            className="pb-[30px] px-[24px] lg:px-[48px] w-full flex flex-row flex-nowrap gap-3 h-[472px] md:h-[947px] lg:h-[577px] xl:h-[827px] overflow-x-scroll scrollbar-none hover:scrollbar scrollbar-thin scrollbar-track-transparent scrollbar-thumb-[#8c8c8cff]">
